...
import com.knoldus.hibernate.example.model.ClassRoom;
import com.knoldus.hibernate.example.model.Student;
...
public class HibernateExample {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("David Hussey", cal.getTime(), "Australia", "1234566");
